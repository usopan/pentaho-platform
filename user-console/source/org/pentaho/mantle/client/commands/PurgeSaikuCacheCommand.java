...
public class PurgeSaikuCacheCommand extends AbstractCommand {
	public PurgeSaikuCacheCommand() {
	}

	protected void performOperation() {
		final String url = GWT.getHostPageBaseURL()
				+ "plugin/saiku/api/existinguser/discover/refresh?_="+System.currentTimeMillis(); //$NON-NLS-1$
